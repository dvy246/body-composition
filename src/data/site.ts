...
export const calculators: Calculator[] = [
	...
	},
	{
		...
		seoTitle: 'Body Composition & Navy Method Body Fat Calculator | BodyCompOS',
		metaDescription: 'Estimate your body fat percentage using the US Navy Method, and calculate lean mass, fat mass, BMI, and a complete composition snapshot.',
		mode: 'composition',
		description: 'Generate a comprehensive body composition snapshot integrating BMI, WHtR, lean mass, fat mass, and body fat percentage. Automatically runs the US Navy Circumference Method (neck, waist, hip measurements) to supply your body fat inputs.',
		primaryInputs: ['Height', 'Weight', 'Neck', 'Waist', 'Optional Hip', 'Optional entered body fat'],
		formula: 'Combines the US Navy Circumference Method equations with LBM, BMI, and WHtR screening logic.',
		interpretation: 'Use the snapshot to choose a body composition strategy, not as a standalone diagnosis. Always track progress using consistent tools.',
		related: ['ffmi-calculator', 'lean-body-mass-calculator', 'bmi-calculator'],
		faqs: [
			['How accurate is the US Navy body fat method?', 'The US Navy Circumference Method provides a statistical estimate that is typically within ±3-4% of DEXA scan accuracy. It is highly practical and zero-cost for tracking relative trend changes.'],
			['Why does the formula require neck and waist circumferences?', 'Neck and waist circumferences track regional body fat distribution. For women, hip circumference is also factored in to account for gynoid fat storage patterns.'],
			...defaultFaqs,
		],
	},
	{
...
export const calculatorCategories = [
	...
	},
	{
		...
		slugs: ['ffmi-calculator', 'lean-body-mass-calculator', 'bmi-calculator', 'waist-to-height-ratio-calculator', 'body-composition-calculator'],
	},
	{
		title: 'Goal Planning',
